...
- **Full provenance** — every feature cites its sources; **173 segments carry real OpenStreetMap track geometry**
...
This repository is a **point-in-time snapshot (2026-07-25)** generated from the Levantrain database
...
**173 of 269 route segments carry real surveyed track geometry** recovered from OpenStreetMap; the rest
