...
Every fact in this database is cited to one of the sources below. The **canonical, machine-readable**
list is [`data/sources.json`](../data/sources.json); attribute-level citations (which source backs which
...
| --- | --- | --- | --- | --- | --- |
| `arabnews_hejaz` | The Hejaz Railway | Arab News | news | secondary | [link](https://www.arabnews.com/node/1475651/saudi-arabia) |
| `awm_hbt` | The Haifa–Beirut–Tripoli Railway (A. E. Field, appendix) | Australian War Memorial | primary | secondary | [link](https://s3-ap-southeast-2.amazonaws.com/awm-media/collection/RCDIG1070091/document/5519420.PDF) |
| `bdr_project` | Beirut–Damascus Railway — Stations (with altitudes) | Beirut-Damascus Railway project | specialist | secondary | [link](https://beirutdamascusrailway.wordpress.com/stations/) |
...
| `wp_enr` | Egyptian National Railways | Wikipedia | encyclopedia | secondary | [link](https://en.wikipedia.org/wiki/Egyptian_National_Railways) |
| `wp_hejaz` | Hejaz railway | Wikipedia | encyclopedia | secondary | [link](https://en.wikipedia.org/wiki/Hejaz_railway) |
| `wp_iraq` | Rail transport in Iraq | Wikipedia | encyclopedia | secondary | [link](https://en.wikipedia.org/wiki/Rail_transport_in_Iraq) |
| `wp_israel_rw` | Rail transport in Israel | Wikipedia | encyclopedia | secondary | [link](https://en.wikipedia.org/wiki/Rail_transport_in_Israel) |
| `wp_jaffa_jerusalem` | Jaffa–Jerusalem railway | Wikipedia | encyclopedia | secondary | [link](https://en.wikipedia.org/wiki/Jaffa%E2%80%93Jerusalem_railway) |
| `wp_jezreel` | Jezreel Valley railway | Wikipedia | encyclopedia | secondary | [link](https://en.wikipedia.org/wiki/Jezreel_Valley_railway) |
| `wp_jordan` | Rail transport in Jordan | Wikipedia | encyclopedia | secondary | [link](https://en.wikipedia.org/wiki/Rail_transport_in_Jordan) |
| `wp_lebanon` | Rail transport in Lebanon | Wikipedia | encyclopedia | secondary | [link](https://en.wikipedia.org/wiki/Rail_transport_in_Lebanon) |
| `wp_palestine_rw` | Palestine Railways | Wikipedia | encyclopedia | secondary | [link](https://en.wikipedia.org/wiki/Palestine_Railways) |
| `wp_syria` | Rail transport in Syria | Wikipedia | encyclopedia | secondary | [link](https://en.wikipedia.org/wiki/Rail_transport_in_Syria) |
